				...
				elements:[
					{//status column
						...
						'processCallback':{
							'success':function(callObj){
								buildNotifyMsg('Update successfully!','success');
								apex.event.trigger($('#communication-status-chart'),'apexrefresh');
							},
							'fail':function(callObj){
								buildNotifyMsg('Update failed!','warning');
							}
						...
						'data':[
							{'display':'','value':'no email address or name (for contact)'},
							{'display':'','value':'out of office'},
							{'display':'','value':'complete'},
							{'display':'','value':'unscheduled'},
							{'display':'','value':'waiting for SR confirmation \/ reminder limit not reached'},
							{'display':'','value':'waiting for SR confirmation \/ reminder limit reached'},
							{'display':'','value':'response threshold reached'},
							{'display':'','value':'no response \/ reminder limit not reached'},
							{'display':'','value':'no response \/ reminder limit reached'},
							{'display':'','value':'response \/ reminder limit not reached'},
							{'display':'','value':'response \/ reminder limit reached'}
						],
                        'db_column':'MANUAL_STATUS'
					}
